...
public class MatFileReader
{
    ...
    static {
        final Object hack = AccessController.doPrivileged((PrivilegedAction<Object>) MatFileReader::unmapHackImpl);
        ...
        finally
        {
            if ( roChannel != null )
            {
                try {
                    ...
                    //swallow
                    LOG.warn("problem closing file", e);
                }
            }
            if ( raFile != null )
            {
...
//                char[] ac = tag.readToCharArray();
            ...
            case MLArray.mxOPAQUE_CLASS:
                if (ALLOW_OBJECT_DESERIALIZATION) {
                    ...
                    String arrName = new String(nn, StandardCharsets.US_ASCII);
